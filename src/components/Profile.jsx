...
const Profile = () => {
    return (
        <div className={style["container--profile"]}>
            ...
            <div className={style["container--profile_description"]}>
                <span>Nombre</span>
                <p></p>
                <a href="#">Enlace de algo</a>
            </div>
        </div>
    );
}
